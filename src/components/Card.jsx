...
function Card({name, price, cover}) {
    ...
    return (
        <div className="card">
            ...
            <svg onClick = {onClickFavourites} className={favouriteItem ? 'card__add-to-fav icon_active' : 'card__add-to-fav' } width="30px" height="30px" viewBox="0 0 24 24" fill="transparent" xmlns="http://www.w3.org/2000/svg">
